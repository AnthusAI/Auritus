...
The public site is live at [aurit.us](https://aurit.us). Kokoro speech is
generated by local workers and by the AWS Batch GPU fallback. Operator CLI
login is Cognito email and password. See the Kanbus board (`kbs now`) for
